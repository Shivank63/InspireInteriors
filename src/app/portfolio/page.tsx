...
const projects = [
  {
    ...
    description: "A serene and sophisticated living space featuring clean lines and natural materials.",
  ...
  },
  {
    ...
    description: "Transforming a traditional office into a collaborative and inspiring workspace.",
  ...
  },
  {
    ...
    description: "An elegant penthouse design combining luxury with comfort and functionality.",
  ...
  },
  {
    ...
    description: "Creating a welcoming and memorable first impression for hotel guests.",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    description: "Light, airy spaces with natural textures and functional design.",
    ...
    <div className="pt-20">
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="font-playfair text-4xl lg:text-6xl font-bold text-gray-900 mb-6">Our Portfolio</h1>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        {project.tags.map((tag) => (
                          <span key={tag} className="text-gray-300 text-xs px-2 py-1 bg-black/30 rounded">
                            {tag}
                          </span>
                        ))}
                      </div>
